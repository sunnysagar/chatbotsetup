...
const EchoAssistant = () => {
  ...
  const [showIntegrationInstructions, setShowIntegrationInstructions] =
    useState(false);
  ...
  return (
    <div className="echo-container">
      <div className="echo-card">
        ...
        <p>
          All your questions will be answered by an AI assistant. Ask here,
          please!
        </p>
        ...
        >
          ...
          {showIntegrationInstructions && (
            ...
            >
              ...
              <div className="email-instructions">
                <p>
                  If you need help, we can send the instructions to your
                  developer via email.
                </p>
                <motion.button
          ...
          {showTestResult && !testSuccessful && (
            ...
            >
              ...
              <p>
                The chatbot integration couldn't be detected. Please try again.
              </p>
              <motion.button
